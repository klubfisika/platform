...
export const NOTIFICATION_DROPDOWN_STYLES = {
  ...
  avatarUser:
    "w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm",
  avatarSystem:
    "w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-lg",
