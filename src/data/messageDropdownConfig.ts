...
export const MESSAGE_DROPDOWN_STYLES = {
  ...
  icon: "text-xl",
  badge:
    "absolute -top-1 -right-1 w-5 h-5 bg-green-500 text-white text-xs rounded-full flex items-center justify-center font-bold",
  backdrop: "fixed inset-0 z-40",
  dropdown:
    "absolute right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden",
  ...
  messageItem:
    "p-4 border-b border-gray-50 hover:bg-gray-50 cursor-pointer transition",
  messageUnread: "bg-green-50",
  messageContent: "flex gap-3",
  avatar: "flex-shrink-0",
  avatarCircle:
    "w-10 h-10 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm",
