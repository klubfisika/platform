...
export const mockMessages: Message[] = [
  {
    id: "m1",
    from: {
      username: "ahmad_fisika",
      displayName: "Ahmad Fisika",
      avatar: "A",
    },
    to: { username: "current_user", displayName: "You" },
    subject: "Tentang Eksperimen Interferometer",
    message:
      "Gan, boleh tanya detail setup interferometer kamu? Ane pengen coba bikin juga nih.",
    time: "10 menit lalu",
    read: false,
  },
  {
    ...
    message:
      "Halo! Ane tertarik dengan thread kamu tentang Schrödinger. Mau diskusi lebih lanjut?",
    time: "1 jam lalu",
    read: false,
  },
  {
