    ...
    replies: [
      {
        ...
        content:
          "Diagram yang sangat membantu! Bisa ditambahkan tahap dokumentasi juga?",
        cendol: 12,
        bata: 0,
...
Voila! **Persamaan Schrödinger**! :mantap`,
    ...
    replies: [
      ...
      },
      {
        ...
        content:
          "Gan, ane masih bingung di bagian variasi. Kenapa kita variasi terhadap $\\psi^*$ bukan $\\psi$? :bingung",
        cendol: 3,
        bata: 0,
        createdAt: "2 jam lalu",
      },
  ...
  "kenapa-momentum-angular-kekal-tapi-energi-kinetik-r9s0t1u2v3w4": {
    ...
    title:
      "Kenapa momentum angular kekal tapi energi kinetik tidak pada tumbukan?",
    type: "ask",
...
Mohon pencerahannya gan! :salaman`,
  ...
  "bikin-sensor-suhu-lcd-dengan-arduino-untuk-eksperi-x5y6z7a8b9c0": {
    ...
    title:
      "Bikin sensor suhu + LCD dengan Arduino untuk eksperimen termodinamika",
    type: "tutorial",
...
Selamat mencoba! :gas`,
    ...
    replies: [
        ...
        replies: [
          {
            ...
            author: { name: "arduino_newbie", rank: "Newbie", posts: 8 },
            content:
              "Solved gan! Ternyata address I2C nya 0x3F bukan 0x27. Makasih! :salaman",
            cendol: 8,
            bata: 0,
      ...
      },
      {
        ...
        content:
          "Keren gan! Ane mau pake ini buat praktikum termodinamika. Bisa ditambah data logging ke SD card gak? :cool",
        cendol: 15,
        bata: 0,
...
Lebih cepat dari rumus! :mantap`,
    ...
    replies: [
      ...
      },
      {
        ...
        content:
          "Metode bagus gan! Ane juga ngajarin ini ke siswa. Visualisasi grafik bikin konsep lebih mudah dipahami daripada hafal rumus buta. :cool",
        cendol: 22,
        bata: 0,
        createdAt: "12 jam lalu",
      },
...
Good luck! :jempol`,
    ...
    replies: [
      ...
      },
      {
        ...
        content:
          "IPK 3.4 masih oke kok gan! Ane dulu 3.45 juga lolos. Yang penting essay dan achievement lainnya kuat. LPDP itu holistic assessment. :jempol",
        cendol: 42,
        bata: 0,
        createdAt: "4 jam lalu",
      },
    ...
    replies: [
      {
        ...
        content:
          "Kuncinya di **akselerasi**! B mengalami akselerasi saat berangkat dan pulang, A tidak. Jadi B yang lebih muda. :mantap",
        cendol: 25,
        bata: 0,
...
Resolusi: ~2 nm. Lumayan untuk DIY! :gas`,
    ...
    replies: [
      ...
      },
      {
        ...
        author: { name: "maker_indo", rank: "Aktivis", posts: 67 },
        content:
          "Pake yang silver gan, yang ungu (DVD-R) kurang bagus difraksinya. DVD silver punya track spacing ~740 nm, cocok buat visible light.\n\nTips: lepas lapisan reflektif nya dulu, biar cuma plastic transparan aja. :jempol",
        cendol: 25,
        bata: 0,
        createdAt: "20 jam lalu",
      },
      {
        ...
        content:
          "Mantap gan! Resolusi 2 nm udah bagus buat DIY. Spektrometer lab ane yang 50 juta juga cuma 1 nm :ngakak\n\nBoleh share tutorial lengkapnya? Mau ane pake buat praktikum mahasiswa.",
        cendol: 31,
        bata: 0,
