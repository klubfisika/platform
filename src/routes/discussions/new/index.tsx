      ...
      <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <form class="p-6 space-y-6">
          ...
          <div>
            ...
            <input type="text" name="tags" placeholder="fisika, eksperimen, diy (pisahkan dengan koma)" class="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
          ...
          <div>
            ...
            <div class="border border-gray-200 rounded-lg overflow-hidden">
              <div class="bg-gray-50 px-3 py-2 border-b border-gray-200 flex items-center gap-2">
                <button type="button" class="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" title="Bold"><strong>B</strong></button>
                <button type="button" class="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" title="Italic"><em>I</em></button>
                <button type="button" class="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" title="Code">💻</button>
                <button type="button" class="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" title="Math">∑</button>
                <button type="button" class="p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" title="Emoticon">😀</button>
              </div>
              <textarea name="content" placeholder="Tulis konten thread... Mendukung Markdown, LaTeX, dan emoticon Kaskus!" class="w-full p-4 resize-none focus:outline-none" rows={12} required></textarea>
            </div>
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            <a href="/discussions" class="px-4 py-2 text-gray-600 hover:text-gray-800 transition">Batal</a>
            <div class="flex gap-3">
              <button type="button" class="px-4 py-2 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition">Simpan Draft</button>
              <button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition">Posting Thread</button>
            </div>
          </div>
        </form>
      </div>
